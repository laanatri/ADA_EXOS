        ...
        var r = "pagination",
            ...
            D =
                    ...
                    if (void 0 !== a) {
                            ...
                            e = {
                                ...
                                generateHTML: function (a) {
                                    var e,
                                        ...
                                        O =
                                            "function" ==
                                            typeof J.autoHidePrevious
                                                ? J.autoHidePrevious()
                                                : J.autoHidePrevious,
                                        z =
                                            "function" ==
                                            typeof J.autoHideNext
                                                ? J.autoHideNext()
                                                : J.autoHideNext,
                                        L =
                                            "function" ==
                                    ...
                                    if (
                                            ...
                                            l &&
                                                (o <= 1
                                                    ...
                                                    : (x += `<li class="${y}-prev J-paginationjs-previous ${k}" data-num="${
                                                          o - 1
                                                      }" title="Previous page">${n(
                                                          b
                                                      )}</li>`)),
                                            u &&
                                                (x +=
                                                    t.generatePageNumbersHTML(
                                                        a
                                                    )),
                                            c &&
                                                (i <= o
                                        ...
                                        (e = j += "</select>"),
                                            (x += `<div class="paginationjs-size-changer">${(e =
                                                T
                                                    ? t.replaceVariables(
                                                          T,
                                                          {
                                    ...
                                    return (
                                        d &&
                                            H &&
                                            (x += `<div class="${y}-go-input">${(e =
                                                t.replaceVariables(H, {
                                                    currentPage: o,
                                                    totalPage: i,
                                                    totalNumber: r,
                                                    input: S,
                        ...
                        i.dataSource || l('"dataSource" is required.'),
                            ...
                            void 0 !== i.formatResult &&
                                ...
                                l(
                                    '"formatResult" should be a Function.'
                                ),
                            void 0 !== i.onError &&
                ...
                (u[r] = function (a, e) {
                    ...
                    if (
                        (arguments.length < 2 &&
                            l("Requires two parameters."),
                        (t =
                            "string" != typeof a && a instanceof jQuery
                                ? a
                                : u(a)).length)
                    )
